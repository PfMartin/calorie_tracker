/*
* Controller functions are immediatelly invoked functions (extra parenthesis at the end)
* Each controller is one module
* Each Controller returns various functions. This is to access data or functions from the browser. Otherwise it can't be accessed from Chrome
*/ 
...
const ItemCtrl = (function() {
    ...
    return {
        ...
        addItem: function(name, calories) {
            ...
            // Calories intput from string to number
